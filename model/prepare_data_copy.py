...
train = pd.read_csv('E:\\kaggle\\Grocery-Sales-Forecasting\\data\\train_sample.csv', dtype=dtypes, parse_dates=[1])
test = pd.read_csv('E:\\kaggle\\Grocery-Sales-Forecasting\\data\\test.csv', dtype=dtypes, parse_dates=[1])
...
stores = pd.read_csv('E:\\kaggle\\Grocery-Sales-Forecasting\\data\\stores.csv')
...
items = pd.read_csv('E:\\kaggle\\Grocery-Sales-Forecasting\\data\\items.csv')
