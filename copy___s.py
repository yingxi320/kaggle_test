...
train = pd.merge(train, air_store_info, how='left', on=['air_store_id', 'day_of_week'])
test = pd.merge(test, air_store_info, how='left', on=['air_store_id', 'day_of_week'])
...
data = pd.merge(data, hpg_reserve, on='air_store_id', how='left')
del hpg_reserve
data = pd.merge(data, air_reserve, on='air_store_id', how='left')
